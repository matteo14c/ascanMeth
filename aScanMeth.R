...
#if (commonCpG$covM1 < commonCpG$covM2)
#{
...
#}else if(commonCpG$coVM2 < commonCpG$covM1 ){
#	corM2<-commonCpG$covM1/commonCpG$covM2
#        commonCpG$covM2<-commonCpG$covM2*corM2
#        commonCpG$nmodM2<-as.integer(commonCpG$nmodM2*corM2)
#}
...
write.table(commonCpG,"completeData.csv")
